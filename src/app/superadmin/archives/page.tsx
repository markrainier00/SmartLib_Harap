...
export default function SuperAdminAccounts() {
    ...
    const fetchAccounts = async () => {
        setIsLoading(true);
        try {
        const json = await api.get("/api/admin/archivedUsers");
    ...
    <div className="app">
        ...
        <div style={{ marginBottom: 20 }}>
            ...
            <div className="page-sub">Administrator control panel for archived student and staff users.</div>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", marginBottom: 18, justifyContent: "space-between", alignItems: "center" }}>
            ...
            {(roleFilter !== "All Users" || search) && (
                <button className="pills" onClick={() => { setRoleFilter("All Users"); setSearch(""); }} style={{ background: "#f5f5f5", borderColor: "#dadada", color: "#777777" }}>
                Reset
                </button>
            )}
            </div>
