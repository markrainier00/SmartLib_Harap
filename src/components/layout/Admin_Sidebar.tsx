...
import { IconBookReq, IconBorrowHis, IconDashboard, IconData, IconHamburger, IconLibManage, IconManageAcc, IconRegistration } from "../icons";
...
export default function Sidebar({ isSidebarOpen, toggleSidebar }: SidebarProps) {
  ...
  const NAV_ITEMS = [
    ...
    { id: "/admin/requests", icon: <IconBookReq/>, label: "Book Requests"/*, badge: 3 */},
    { id: "/admin/history", icon: <IconBorrowHis/>, label: "Borrow History" },
    { id: "/admin/approvals", icon: <IconRegistration/>, label: "Registration"/*, badge: 5 */},
